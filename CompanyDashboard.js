...
const CompanyDashboard = () => {
    ...
    const fetchJobOffers = async () => {
      ...
      useEffect(() => {
        ...
        fetchJobOffers();
      }, [selectedApplication,interviewDetails]); // Run only once when component mounts
    useEffect(() => {
    ...
    }, [location, navigate, fetchJobs, fetchJobsWithApplications, jobId,setScheduledApplications]); // No redundant dependencies
